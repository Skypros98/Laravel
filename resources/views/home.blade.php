        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-5">
                            <ul class="nav nav-pills nav-pills-custom justify-content-md-end" id="pills-tab-custom"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile-tab-custom" data-bs-toggle="pill"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact-tab-custom" data-bs-toggle="pill"
                    ...
                    <canvas id="audience-chart" style="display: block; width: 454px; height: 227px;" width="454"
