    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="navbar col-lg-12 col-12 px-0 py-0 py-lg-4 d-flex flex-row">
        <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
          ...
          <h4 class="font-weight-bold mb-0 d-none d-md-block mt-1">Welcome back, Brandon Kent</h4>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                <img src="https://yt3.googleusercontent.com/ytc/APkrFKbWbbe2aDG0wRxFiZ9tGfwm0w13ELKbVqXNbD7vQQ=s900-c-k-c0x00ffffff-no-rj" alt="profile"/>
                <span class="nav-profile-name">Brandon Kent</span>
              </a>
